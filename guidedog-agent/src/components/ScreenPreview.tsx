    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.headerLeft}>
          ...
          <Text style={styles.headerTitle}>视图树</Text>
          {loadState === 'loading' && (
      ...
      <View style={[styles.body, expanded ? styles.bodyExpanded : styles.bodyCollapsed]}>
        <ScrollView
          style={styles.scroll}
        ...
        >
          {loadState === 'idle' && (
            <Text style={styles.placeholder}>点击标题加载当前屏幕状态。</Text>
          )}
