...
10 tools total: tap, long_press, fill, swipe, scroll, open_app, inspect_ui, screenshot, global_action, task_complete.
...
WEB: [
  ...
  'fill',        // search boxes, address bar
  'press_enter', // submit
  'scroll',      // page scroll
  'inspect_ui', // read DOM via a11y tree
