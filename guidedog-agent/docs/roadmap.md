...
- `ui_find_node.matches` + multi-step scroll-until-found for agents operating in long lists (candidate-list lookup shipped; scroll-until-found pattern still to document)
